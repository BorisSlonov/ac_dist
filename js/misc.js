...
function bt_video_resize() {
	...
	$(".construc1").css( 'height', '1400' );
	$(".construc2").css( 'height', '810' );
	$(".construc3").css( 'height', '1450' );
	$(".construc4").css( 'height', '1000' );
}
	...
	$( '.tabsHorizontal' ).each(function() {
        ...
        $(document).ready(function(){
            ...
            $('#new-form input[type="submit"').click(function(){
                ...
                // отправляем данные
                $.ajax({
                    url: "/newmail.php", // куда отправляем
